...
;(() => {
  ...
  a.newelem = newfunc(
    ...
    function ({
      ...
      data = maketype(data, ["undefined", "object"])
      inside = maketype(inside, ["undefined", "array"])
      return end()
    }
  )
  a.cap = newfunc(
    ...
    function ({
      ...
      ifunset(null, null, null)
      num = maketype(num, ["number"])
      min = maketype(min, ["number", "undefined", "null"])
      max = maketype(max, ["number", "undefined", "null"])
      return end()
    }
  )
